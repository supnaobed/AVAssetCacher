...
class GSPlayerControlUIView: UIView {
    ...
    @IBOutlet var duration_Slider: UISlider!
    @IBOutlet var currentDuration_Label: UILabel!
    @IBOutlet var totalDuration_Label: UILabel!
...
extension GSPlayerControlUIView {
    @IBAction func onClicked_Play(_: Any) {
    ...
    @IBAction func onClicked_Video(_: Any) {
