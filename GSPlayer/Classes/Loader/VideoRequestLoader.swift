...
extension VideoRequestLoader: VideoDownloaderDelegate {
    func downloader(_: VideoDownloader, didReceive _: URLResponse) {
        fulfillContentInfomation()
    }

    func downloader(_: VideoDownloader, didReceive data: Data) {
        request.dataRequest?.respond(with: data)
    }

    func downloader(_: VideoDownloader, didFinished error: Error?) {
...
private extension VideoRequestLoader {
    func fulfillContentInfomation() {
        guard
            ...
            request.contentInformationRequest != nil
        else {
            return
        }
